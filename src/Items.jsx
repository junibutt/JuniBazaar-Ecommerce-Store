        ...
        <div className="flex gap-4 flex-col md:gap-2">
          <div className="flex gap-4 md:gap-2 lg:gap-3 flex-col md:flex-row md:mx-auto">
            ...
            <div className="md:w-[29%] mx-auto relative">
              ...
              <button
                onClick={() => handleaddtocart({ id: 1, name: "LV Shirt", price: 200 })}
                className="absolute top-2 right-2 bg-yellow-400 text-black px-2 py-1 text-xs font-bold rounded cursor-pointer"
              >
                + Add to Cart
              </button>
            </div>
            ...
            <div className="md:w-[29%] mx-auto relative">
              ...
              <button
                onClick={() => handleaddtocart({ id: 2, name: "Full Pack Dress", price: 555 })}
                className="absolute top-2 right-2 bg-yellow-400 text-black px-2 py-1 text-xs font-bold rounded cursor-pointer"
              >
                + Add to Cart
              </button>
            ...
            <div className="md:w-[40%] mx-auto relative">
              ...
              <button
                onClick={() => handleaddtocart({ id: 3, name: "Sneakers", price: 232 })}
                className="absolute top-2 right-2 bg-yellow-400 text-black px-2 py-1 text-xs font-bold rounded cursor-pointer"
              >
                + Add to Cart
              </button>
          ...
          <div className="flex mx-auto md:w-[100%] md:relative">
            <div className="relative md:w-[58.6%] w-full">
              <img
                className="w-full h-[400px] md:h-[245px] lg:h-[332px] lg:top-[-340px] md:absolute md:top-[-253px] object-cover"
                src={nailpaint}
                alt="Nail Paint"
              />
              <div className="absolute top-2 md:top-[-246px] lg:top-[-330px] left-2 bg-black text-white px-2 py-1 text-sm font-bold rounded">
                50$ only
              </div>
              <button
                onClick={() => handleaddtocart({ id: 4, name: "Nail Paints", price: 50 })}
                className="absolute top-2 md:top-[-246px] right-2 lg:top-[-330px] bg-yellow-400 text-black cursor-pointer px-2 py-1 text-xs font-bold rounded"
              >
                + Add to Cart
              </button>
            </div>
